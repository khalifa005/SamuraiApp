...
namespace SamuraiApp.Data.Migrations
{
    ...
    [Migration("20201127133238_DbFunctonAndView")]
    partial class DbFunctonAndView
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SamuraiApp.Domain.Battel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SamuraiApp.Domain.SamuraiBattel", b =>
                {
                    ...
                    b.HasKey("BattelId", "SamuraiId");

                    b.HasIndex("SamuraiId");

                    b.ToTable("SamuraiBattel");
                });
            ...
            modelBuilder.Entity("SamuraiApp.Domain.SamuraiBattel", b =>
                {
                    b.HasOne("SamuraiApp.Domain.Battel", "Battel")
                        .WithMany("SamuraiBattels")
                        .HasForeignKey("BattelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
